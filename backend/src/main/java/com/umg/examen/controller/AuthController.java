...
public class AuthController {
    ...
    @PostMapping("/refresh")
    @Operation(summary = "Renovar token de acceso", description = "Rota un refresh token válido y entrega credenciales renovadas")
    ...
    @PostMapping("/logout")
    @Operation(summary = "Cerrar sesión", description = "Revoca el refresh token activo para evitar nuevas renovaciones de sesión")
