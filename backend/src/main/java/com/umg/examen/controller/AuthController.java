...
public class AuthController {
    ...
    @PostMapping("/refresh")
    @Operation(summary = "Renovar tokens", description = "Rota el refresh token y emite un nuevo token de acceso")
    ...
    @PostMapping("/logout")
    @Operation(summary = "Cerrar sesión", description = "Revoca los tokens de acceso y renovación de la sesión")
    public ResponseEntity<ApiResponse<Void>> logout(
        ...
        String accessToken = authorization != null && authorization.startsWith("Bearer ")
                ...
                : null;
        authService.logout(request != null ? request.getRefreshToken() : null, accessToken);
