...
public class AuthController {
    ...
    @Operation(summary = "Renovar access token",
            description = "Valida el refresh token contra la base de datos, lo revoca (rotación) y emite un nuevo par access/refresh token. "
                    + "Si el refresh token está expirado, revocado o fue reutilizado responde 401.")
