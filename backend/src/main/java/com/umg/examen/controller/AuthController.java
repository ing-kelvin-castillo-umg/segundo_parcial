...
public class AuthController {
    ...
    @PostMapping("/refresh")
    @Operation(summary = "Renovar sesión", description = "Valida y rota el Refresh Token, retornando un nuevo par de tokens")
    ...
    @PostMapping("/logout")
    @Operation(summary = "Cerrar sesión", description = "Revoca el Refresh Token de la sesión")
