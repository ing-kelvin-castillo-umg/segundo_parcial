...
public class AuthController {
    ...
    @PostMapping("/refresh")
    @Operation(summary = "Renovar sesión", description = "Rota el refresh token y devuelve un nuevo token de acceso")
    ...
    @PostMapping("/logout")
    @Operation(summary = "Cerrar sesión", description = "Invalida el token de acceso y revoca el refresh token")
