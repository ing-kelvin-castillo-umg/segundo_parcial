...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 bg-brand-950 text-brand-50 relative overflow-hidden">
      ...
      <div className="w-full max-w-md mb-6">
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 text-xs font-semibold text-brand-200/70 hover:text-white transition-colors"
        >
      ...
      {/* Login Card */}
      <div className="w-full max-w-md bg-brand-900/90 backdrop-blur-xl border border-brand-700 rounded-3xl p-8 shadow-2xl shadow-brand-950/50 space-y-6">
        {/* Header */}
        ...
        <div className="p-3.5 rounded-2xl bg-brand-950/40 border border-brand-700/70 space-y-2">
          <span className="text-[11px] font-bold text-brand-100/70 uppercase tracking-wider block">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-brand-100 uppercase mb-1.5">
              Usuario
            </label>
            <div className="relative">
              <UserIcon className="w-4 h-4 text-brand-200/60 absolute left-3.5 top-1/2 -translate-y-1/2" />
              <input
                type="text"
                required
                value={username}
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-brand-700 bg-brand-950/70 text-white placeholder-brand-200/40 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <KeyRound className="w-4 h-4 text-brand-200/60 absolute left-3.5 top-1/2 -translate-y-1/2" />
              <input
                type="password"
                required
                value={password}
