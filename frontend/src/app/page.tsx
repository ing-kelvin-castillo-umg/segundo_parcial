...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-brand-950 text-brand-50">
      <Navbar />
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-16">
        ...
        <section className="text-center space-y-5 max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-white leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-300 via-brand-100 to-accent-300">
              Productos
            </span>
          </h1>

          <p className="text-brand-100/75 text-base sm:text-lg leading-relaxed">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            {isAuthenticated ? (
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-600 hover:bg-brand-500 text-white font-semibold text-sm shadow-lg shadow-brand-600/30 transition-all hover:scale-105"
              >
              ...
              <>
                ...
                <a
                  href="#catalogo"
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-brand-900 hover:bg-brand-800 text-brand-100 border border-brand-700 font-medium text-sm transition-all"
                >
        ...
        <section id="catalogo" className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-brand-200/55 hidden sm:inline">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
          <div className="p-6 rounded-2xl bg-brand-900/70 border border-brand-800 space-y-3 shadow-lg shadow-brand-950/30">
            ...
            <p className="text-xs text-brand-100/70 leading-relaxed">
              Control de acceso con roles <span className="text-brand-300 font-mono">ROLE_ADMIN</span> y <span className="text-emerald-300 font-mono">ROLE_USER</span>. Permisos diferenciados para consulta y mutación de inventario.
            </p>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-brand-800 py-8 text-center text-xs text-brand-200/60">
