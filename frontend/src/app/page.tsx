...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-harbor-950 text-harbor-50">
      <Navbar />
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-16">
        ...
        <section className="text-center space-y-5 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-citrus-200/10 border border-citrus-200/20 text-citrus-200 text-xs font-semibold tracking-wide">
          ...
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-white leading-tight">
            ...
            <span className="text-citrus-200">
              Productos
            </span>
          </h1>

          <p className="text-harbor-100/75 text-base sm:text-lg leading-relaxed">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            {isAuthenticated ? (
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-coral-500 hover:bg-coral-400 text-white font-semibold text-sm shadow-lg shadow-coral-900/30 transition-all hover:scale-105"
              >
              ...
              <>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-harbor-900 hover:bg-harbor-800 text-harbor-100 border border-harbor-700 font-medium text-sm transition-all"
                >
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <Zap className="w-5 h-5 text-citrus-300" />
                <span>Productos Destacados</span>
              </h2>
              <p className="text-xs text-harbor-100/70">
                Explora el catálogo dinámico de productos activos
              </p>
            </div>
            <span className="text-xs text-harbor-100/55 hidden sm:inline">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
          <div className="p-6 rounded-2xl bg-harbor-900/70 border border-harbor-800 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-citrus-200/10 text-citrus-200 flex items-center justify-center">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold text-white">Seguridad &amp; Roles JWT</h3>
            <p className="text-xs text-harbor-100/70 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-harbor-900/70 border border-harbor-800 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-coral-500/10 text-coral-300 flex items-center justify-center">
          ...
          <div className="p-6 rounded-2xl bg-harbor-900/70 border border-harbor-800 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-harbor-300/10 text-harbor-200 flex items-center justify-center">
      ...
      {/* Footer */}
      <footer className="border-t border-harbor-800/80 py-8 text-center text-xs text-harbor-100/55">
