...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#062c2c] text-slate-100">
      <Navbar />
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-16">
        ...
        <section className="text-center space-y-5 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-lagoon-400/10 border border-lagoon-300/30 text-lagoon-200 text-xs font-semibold tracking-wide">
          ...
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-white leading-tight">
            ...
            <span className="text-lagoon-300">
              Productos
            </span>
          </h1>
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            {isAuthenticated ? (
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-lagoon-400 hover:bg-lagoon-300 text-lagoon-950 font-bold text-sm shadow-lg shadow-lagoon-950/30 transition-all hover:-translate-y-0.5"
              >
              ...
              <>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-white/5 hover:bg-white/10 text-lagoon-100 border border-lagoon-400/25 font-medium text-sm transition-all"
                >
        ...
        <section id="productos-destacados" className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <Zap className="w-5 h-5 text-sand-300" />
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
          <div className="p-6 rounded-2xl bg-white/5 border border-lagoon-300/20 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-lagoon-400/15 text-lagoon-200 flex items-center justify-center">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold text-white">Seguridad &amp; Roles JWT</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              Control de acceso con roles <span className="text-lagoon-200 font-mono">ROLE_ADMIN</span> y <span className="text-emerald-300 font-mono">ROLE_USER</span>. Permisos diferenciados para consulta y mutación de inventario.
            </p>
          </div>

          <div className="p-6 rounded-2xl bg-white/5 border border-lagoon-300/20 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-sand-300/15 text-sand-200 flex items-center justify-center">
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-lagoon-300/20 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-emerald-400/10 text-emerald-300 flex items-center justify-center">
      ...
      {/* Footer */}
      <footer className="border-t border-lagoon-300/15 py-8 text-center text-xs text-lagoon-200/60">
