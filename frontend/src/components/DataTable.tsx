...
export const DataTable: React.FC<DataTableProps> = ({
  ...
  return (
    <section aria-label="Listado de productos" className="w-full bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      {/* Table Toolbar */}
      <div className="p-5 sm:p-6 border-b border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 bg-gradient-to-r from-slate-50 to-white">
        {/* Search Bar */}
        <div className="relative w-full sm:w-96">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-300 bg-white text-sm shadow-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-500 transition-all"
          />
          {searchTerm && (
            <button
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
          <span className="text-xs text-slate-500 font-medium sm:mr-1">
          ...
          {isAdmin ? (
            <button
              onClick={onCreate}
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold shadow-md shadow-slate-900/10 transition-all hover:-translate-y-0.5"
            >
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[860px] text-left text-sm text-slate-600">
          <thead className="bg-slate-100 text-slate-700 text-[11px] uppercase font-bold tracking-[0.12em] border-b border-slate-200">
            <tr>
