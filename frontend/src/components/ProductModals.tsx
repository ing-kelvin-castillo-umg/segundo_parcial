...
export const ViewProductModal: React.FC<ViewProductModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-lagoon-200">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-lagoon-100 bg-lagoon-50/70">
          <div className="flex items-center gap-2">
            <span className="p-1.5 rounded-lg bg-lagoon-100 text-lagoon-700">
        ...
        <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            <div>
              <span className="text-xs font-semibold text-lagoon-600 uppercase tracking-wider">
                {product.category}
              </span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-3.5 rounded-xl bg-lagoon-50 border border-lagoon-100">
                <span className="text-xs text-lagoon-600 font-medium flex items-center gap-1">
                  <DollarSign className="w-3.5 h-3.5" /> Precio Unitario
                </span>
                <p className="text-lg font-bold text-lagoon-900 mt-0.5">{product.formattedPrice}</p>
              </div>
        ...
        {/* Footer */}
        <div className="px-6 py-4 border-t border-lagoon-100 bg-lagoon-50/70 flex justify-end">
          <button
            onClick={onClose}
...
export const ProductFormModal: React.FC<ProductFormModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-lagoon-200">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-lagoon-100 bg-lagoon-50/70">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-lagoon-200 focus:outline-none focus:ring-2 focus:ring-lagoon-400 focus:border-transparent text-sm"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-lagoon-200 focus:outline-none focus:ring-2 focus:ring-lagoon-400 focus:border-transparent text-sm bg-white"
            >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-lagoon-200 focus:outline-none focus:ring-2 focus:ring-lagoon-400 focus:border-transparent text-sm resize-none"
            />
          </div>
          ...
          <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="inline-flex items-center gap-2 px-5 py-2 text-sm font-semibold text-white bg-lagoon-600 hover:bg-lagoon-700 rounded-xl transition-colors disabled:opacity-50"
            >
