  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-brand-950/70 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-brand-100">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-brand-100 bg-brand-50/70">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-slate-400 hover:text-brand-800 hover:bg-brand-100 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
          {/* Large Image Preview */}
          <div className="w-full h-72 rounded-xl overflow-hidden bg-brand-50 border border-brand-100 relative group shadow-inner">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-3.5 rounded-xl bg-accent-50 border border-accent-100">
                ...
                <p className="text-lg font-bold text-accent-900 mt-0.5">{product.formattedPrice}</p>
              </div>
        ...
        {/* Footer */}
        <div className="px-6 py-4 border-t border-brand-100 bg-brand-50/70 flex justify-end">
          <button
            onClick={onClose}
...
export const DeleteConfirmModal: React.FC<DeleteConfirmModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-brand-950/70 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 border border-brand-100">
