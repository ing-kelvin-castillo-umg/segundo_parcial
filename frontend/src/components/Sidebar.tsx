...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-ink-900 text-ink-200 flex flex-col shrink-0 min-h-screen border-r border-ink-800">
      {/* Brand Header */}
      ...
      <nav className="flex-1 px-4 py-6 space-y-1.5">
        ...
        <div className="pt-4 border-t border-ink-800/80 my-4">
          <Link
            href="/"
            className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium text-ink-400 hover:bg-ink-800 hover:text-white transition-all"
          >
