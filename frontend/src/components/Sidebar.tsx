  ...
  return (
    <aside className="w-64 bg-slate-900 text-slate-200 flex flex-col shrink-0 min-h-screen border-r border-slate-800">
      ...
      <div className="p-6 border-b border-slate-800 flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-[#16856f] flex items-center justify-center text-white shadow-lg shadow-[#16856f]/20">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all ${
                isActive
                  ? "bg-[#16856f] text-white shadow-md shadow-[#16856f]/30"
